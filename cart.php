...
if(isset($_GET['delete_all'])){
 ...
 if(isset($_POST['checkout'])){ 
   ...
   $nama = $fetch_cart['name'];
   $harga = $fetch_cart['price'];
   $kuantiti = $fetch_cart['quantity'];
   ...
   <table>
      ...
      <tbody>
         ...
         <tr class="table-bottom">
            ...
            <td><a href="cart.php?delete_all" onclick="return confirm('are you sure you want to delete all?');" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>" > <i class="fas fa-trash"></i> delete all </a></td>
         </tr>
